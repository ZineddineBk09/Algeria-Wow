      ...
      <section className="grid h-fit w-full items-start overflow-y-auto">
        ...
        <div className="flex w-full items-center gap-3 rounded-lg bg-background">
          ...
          <div className="flex w-full flex-col gap-4">
            <div>
              <div className="flex w-full items-center justify-between">
                <h3 className="text-xl font-bold text-primary-blue">Movie</h3>
        ...
        <div className="flex w-full items-center gap-3 rounded-lg bg-background">
          ...
          <div className="flex w-full flex-col gap-4">
            ...
            {/* Date */}
            <div className="-mt-2 flex flex-col items-start gap-y-2 text-primary-blue">
        ...
        <div className="flex w-full items-center gap-3 rounded-lg bg-background">
          ...
          <div className="flex w-full flex-col gap-4">
            <div>
              <div className="flex w-full items-center justify-between">
                <h3 className="text-xl font-bold text-primary-blue">Video</h3>

...
export default function WhatToDo() {
  return (
    <section className="relative flex w-full flex-col items-start justify-between gap-10 rounded-3xl border bg-gray-50 p-16 lg:flex-row lg:gap-12">
      {/* title and search */}
      ...
      {/* Places */}
      <div className="mr-auto flex flex-col items-start justify-center space-y-12 border ">
